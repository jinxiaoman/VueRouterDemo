<template>
  <div id="app">
    ...
    <router-link :to="{ name: 'path1', params: { id: 111 }}">动态路由跳转到Page02</router-link>
    ...
    <h1>用JS实现跳转</h1>
    <button v-on:click="go01">页面1</button>
...
<script>
  export default {
    ...
    methods: {
      ...
      go02: function () {
        this.$router.push({  params: { sex: this.id },query: { name: this.name, age: this.age, sex: this.sex } })
      },
      go03: function () {
